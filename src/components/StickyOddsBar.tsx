...
// SF1: France vs Spain — Jul 14
const SF1_HOME = "1.67"; const SF1_DRAW = "3.50"; const SF1_AWAY = "2.20";
// SF2: Argentina vs England — Jul 15
const SF2_HOME = "2.10"; const SF2_DRAW = "3.50"; const SF2_AWAY = "1.77";
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "0 16px", flexShrink: 0 }}>
          ...
          {[{ label: "1", val: SF2_HOME }, { label: "X", val: SF2_DRAW }, { label: "2", val: SF2_AWAY }].map((o) => (
            <div key={o.label} style={{ textAlign: "center" }}>
              <div style={{ fontSize: "9px", color: "var(--muted)", fontWeight: 700, lineHeight: 1, letterSpacing: "0.05em" }}>{o.label}</div>
              <div style={oddsBoxStyle}>{o.val}</div>
            </div>
