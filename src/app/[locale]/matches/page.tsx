...
const matches = [
  // GROUP A
  {
    ...
    away: { team: 'South Africa', flag: '🇿🇦', form: ['W','D','W','L','W'] },
    odds: { home: '1.65', draw: '3.70', away: '5.50' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.65', draw: '3.70', away: '5.50', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.67', draw: '3.65', away: '5.40', url: ONEXBET_URL },
      { name: 'Bet365', home: '1.62', draw: '3.72', away: '5.55', url: 'https://bet365.com' },
      { name: 'Betway', home: '1.60', draw: '3.75', away: '5.60', url: 'https://betway.com' },
    ],
    status: 'upcoming',
  },
  {
    ...
    away: { team: 'Bolivia', flag: '🇧🇴', form: ['L','D','L','W','L'] },
    odds: { home: '1.80', draw: '3.40', away: '5.00' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.80', draw: '3.40', away: '5.00', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.82', draw: '3.35', away: '4.95', url: ONEXBET_URL },
      { name: 'Bet365', home: '1.78', draw: '3.40', away: '5.05', url: 'https://bet365.com' },
      { name: 'Betway', home: '1.75', draw: '3.45', away: '5.10', url: 'https://betway.com' },
    ],
    status: 'upcoming',
  },
  {
    ...
    odds: { home: '1.93', draw: '3.55', away: '4.30' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.93', draw: '3.55', away: '4.30', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.90', draw: '3.60', away: '4.25', url: ONEXBET_URL },
  ...
  // GROUP B
  {
    ...
    odds: { home: '1.58', draw: '3.95', away: '6.75' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.58', draw: '3.95', away: '6.60', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.55', draw: '3.90', away: '6.75', url: ONEXBET_URL },
  ...
  },
  {
    ...
    odds: { home: '2.35', draw: '3.25', away: '3.10' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.35', draw: '3.25', away: '3.05', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.30', draw: '3.20', away: '3.10', url: ONEXBET_URL },
  ...
  // GROUP C
  {
    ...
    odds: { home: '1.48', draw: '4.25', away: '7.80' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.48', draw: '4.25', away: '7.60', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.45', draw: '4.20', away: '7.80', url: ONEXBET_URL },
  ...
  },
  {
    ...
    odds: { home: '2.35', draw: '3.15', away: '3.08' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.35', draw: '3.15', away: '3.05', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.32', draw: '3.15', away: '3.08', url: ONEXBET_URL },
  ...
  // GROUP D
  {
    ...
    odds: { home: '1.80', draw: '3.65', away: '5.10' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.78', draw: '3.65', away: '5.10', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.80', draw: '3.55', away: '5.05', url: ONEXBET_URL },
  ...
  },
  {
    ...
    odds: { home: '2.75', draw: '3.25', away: '2.68' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.75', draw: '3.25', away: '2.65', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.72', draw: '3.22', away: '2.68', url: ONEXBET_URL },
  ...
  // GROUP E
  {
    ...
    odds: { home: '1.53', draw: '3.95', away: '7.25' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.53', draw: '3.95', away: '7.10', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.50', draw: '3.90', away: '7.25', url: ONEXBET_URL },
  ...
  // GROUP F
  {
    ...
    odds: { home: '1.90', draw: '3.45', away: '4.70' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.88', draw: '3.45', away: '4.70', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.90', draw: '3.40', away: '4.65', url: ONEXBET_URL },
  ...
  // GROUP G
  {
    ...
    odds: { home: '2.00', draw: '3.45', away: '4.20' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.98', draw: '3.45', away: '4.20', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.00', draw: '3.40', away: '4.15', url: ONEXBET_URL },
  ...
  // GROUP H
  {
    ...
    odds: { home: '1.75', draw: '3.65', away: '5.30' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.73', draw: '3.65', away: '5.30', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.75', draw: '3.55', away: '5.25', url: ONEXBET_URL },
  ...
  // GROUP E (cont.)
  {
    ...
    odds: { home: '1.65', draw: '3.85', away: '5.90' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.63', draw: '3.85', away: '5.90', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.65', draw: '3.78', away: '5.85', url: ONEXBET_URL },
  ...
  },
  {
    ...
    away: { team: 'Colombia', flag: '🇨🇴', form: ['W','W','D','W','W'] },
    odds: { home: '2.95', draw: '3.15', away: '2.55' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.95', draw: '3.15', away: '2.55', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.92', draw: '3.12', away: '2.52', url: ONEXBET_URL },
  ...
  // GROUP F (cont.)
  {
    ...
    odds: { home: '1.85', draw: '3.55', away: '4.90' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.83', draw: '3.55', away: '4.90', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.85', draw: '3.48', away: '4.85', url: ONEXBET_URL },
  ...
  },
  {
    ...
    away: { team: 'Belgium', flag: '🇧🇪', form: ['W','D','W','W','D'] },
    odds: { home: '2.65', draw: '3.25', away: '2.75' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.65', draw: '3.25', away: '2.75', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.62', draw: '3.20', away: '2.72', url: ONEXBET_URL },
  ...
  // GROUP G (cont.)
  {
    ...
    odds: { home: '1.90', draw: '3.55', away: '4.50' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.88', draw: '3.55', away: '4.50', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.90', draw: '3.48', away: '4.45', url: ONEXBET_URL },
  ...
  },
  {
    ...
    away: { team: 'Uruguay', flag: '🇺🇾', form: ['W','W','W','D','L'] },
    odds: { home: '2.45', draw: '3.25', away: '2.95' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.45', draw: '3.25', away: '2.95', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.42', draw: '3.20', away: '2.92', url: ONEXBET_URL },
  ...
  // GROUP H (cont.)
  {
    ...
    odds: { home: '1.70', draw: '3.75', away: '5.60' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.68', draw: '3.75', away: '5.60', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.70', draw: '3.65', away: '5.55', url: ONEXBET_URL },
  ...
  },
  {
    ...
    away: { team: 'South Korea', flag: '🇰🇷', form: ['W','D','W','W','L'] },
    odds: { home: '2.25', draw: '3.25', away: '3.25' },
    bookmakers: [
      { name: 'Betsson ★', home: '2.25', draw: '3.25', away: '3.25', url: BETSSON_URL },
      { name: '1xBet ★', home: '2.22', draw: '3.22', away: '3.22', url: ONEXBET_URL },
  ...
  // GROUP B (cont.)
  {
    ...
    away: { team: 'Mexico', flag: '🇲🇽', form: ['W','W','D','W','L'] },
    odds: { home: '5.30', draw: '3.45', away: '1.68' },
    bookmakers: [
      { name: 'Betsson ★', home: '5.30', draw: '3.45', away: '1.67', url: BETSSON_URL },
      { name: '1xBet ★', home: '5.25', draw: '3.40', away: '1.68', url: ONEXBET_URL },
  ...
  // GROUP C (cont.)
  {
    ...
    home: { team: 'Brazil', flag: '🇧🇷', form: ['W','W','D','W','W'] },
    away: { team: 'Ecuador', flag: '🇪🇨', form: ['W','D','L','W','W'] },
    odds: { home: '1.65', draw: '3.85', away: '6.10' },
    bookmakers: [
      { name: 'Betsson ★', home: '1.63', draw: '3.85', away: '6.10', url: BETSSON_URL },
      { name: '1xBet ★', home: '1.65', draw: '3.78', away: '6.05', url: ONEXBET_URL },
  ...
  // GROUP D (cont.)
  {
    ...
    away: { team: 'France', flag: '🇫🇷', form: ['W','D','W','W','W'] },
    odds: { home: '4.60', draw: '3.55', away: '1.83' },
    bookmakers: [
      { name: 'Betsson ★', home: '4.55', draw: '3.55', away: '1.82', url: BETSSON_URL },
      { name: '1xBet ★', home: '4.60', draw: '3.48', away: '1.83', url: ONEXBET_URL },
...
export default function MatchesPage() {
  ...
  function getBookmakers(bks: typeof matches[0]['bookmakers']) {
    if (!isDE) return bks;
    // For DE locale: put 1xBet first (Betsson is #1 everywhere else)
    return [...bks].sort((a, b) => {
