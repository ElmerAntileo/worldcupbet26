...
const groups = [
  {
    id: "A",
    teams: [
      { name: "Mexico", flag: "🇲🇽", toWin: "3.20", qualified: "72%" },
      { name: "Poland", flag: "🇵🇱", toWin: "4.50", qualified: "58%" },
      { name: "Saudi Arabia", flag: "🇸🇦", toWin: "9.00", qualified: "35%" },
      { name: "TBD", flag: "🏳️", toWin: "12.00", qualified: "25%" },
    ],
    topPick: "Mexico",
  ...
  },
  {
    id: "B",
    teams: [
      { name: "USA", flag: "🇺🇸", toWin: "1.80", qualified: "85%" },
      { name: "Mexico", flag: "🇲🇽", toWin: "3.50", qualified: "65%" },
      { name: "Panama", flag: "🇵🇦", toWin: "11.00", qualified: "28%" },
      { name: "TBD", flag: "🏳️", toWin: "14.00", qualified: "22%" },
    ],
    topPick: "USA (home advantage)",
    venue: "MetLife Stadium, New York",
  },
  {
    id: "C",
    teams: [
      { name: "Brazil", flag: "🇧🇷", toWin: "1.55", qualified: "88%" },
      { name: "Argentina", flag: "🇦🇷", toWin: "2.10", qualified: "80%" },
      { name: "Ecuador", flag: "🇪🇨", toWin: "8.00", qualified: "38%" },
      { name: "TBD", flag: "🏳️", toWin: "15.00", qualified: "20%" },
    ],
    topPick: "Brazil + Argentina (group of death)",
    venue: "Hard Rock Stadium, Miami",
  },
  {
    id: "D",
    teams: [
      { name: "Germany", flag: "🇩🇪", toWin: "1.85", qualified: "82%" },
      { name: "France", flag: "🇫🇷", toWin: "2.20", qualified: "76%" },
      { name: "Japan", flag: "🇯🇵", toWin: "7.00", qualified: "42%" },
      { name: "TBD", flag: "🏳️", toWin: "16.00", qualified: "15%" },
    ],
    topPick: "Germany (Euro 2024 champions)",
    venue: "BC Place, Vancouver",
  },
  {
    id: "E",
    teams: [
      { name: "England", flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", toWin: "1.70", qualified: "86%" },
      { name: "Colombia", flag: "🇨🇴", toWin: "3.80", qualified: "60%" },
      { name: "Serbia", flag: "🇷🇸", toWin: "5.50", qualified: "48%" },
      { name: "TBD", flag: "🏳️", toWin: "18.00", qualified: "18%" },
    ],
    topPick: "England (Kane at peak form)",
    venue: "Lincoln Financial Field, Philadelphia",
  },
  {
    id: "F",
    teams: [
      { name: "Spain", flag: "🇪🇸", toWin: "1.60", qualified: "89%" },
      { name: "Belgium", flag: "🇧🇪", toWin: "3.20", qualified: "65%" },
      { name: "Croatia", flag: "🇭🇷", toWin: "5.00", qualified: "50%" },
      { name: "TBD", flag: "🏳️", toWin: "20.00", qualified: "15%" },
    ],
    topPick: "Spain (tournament favourites)",
    venue: "Rose Bowl, Los Angeles",
  },
  {
    id: "G",
    teams: [
      { name: "Portugal", flag: "🇵🇹", toWin: "1.75", qualified: "84%" },
      { name: "Morocco", flag: "🇲🇦", toWin: "3.50", qualified: "62%" },
      { name: "Uruguay", flag: "🇺🇾", toWin: "4.20", qualified: "55%" },
      { name: "TBD", flag: "🏳️", toWin: "22.00", qualified: "14%" },
    ],
    topPick: "Portugal (Ronaldo's last WC)",
  ...
  },
  {
    ...
    teams: [
      ...
      { name: "Senegal", flag: "🇸🇳", toWin: "4.00", qualified: "58%" },
      { name: "South Korea", flag: "🇰🇷", toWin: "5.00", qualified: "50%" },
      { name: "TBD", flag: "🏳️", toWin: "18.00", qualified: "16%" },
    ],
    topPick: "Netherlands (Van Dijk-led defence)",
    venue: "Empower Field, Denver",
  },
  {
    id: "I",
    teams: [
      { name: "TBD (AFC 1)", flag: "🏳️", toWin: "8.00", qualified: "40%" },
      { name: "TBD (CONMEBOL)", flag: "🏳️", toWin: "10.00", qualified: "35%" },
      { name: "TBD", flag: "🏳️", toWin: "14.00", qualified: "22%" },
      { name: "TBD", flag: "🏳️", toWin: "18.00", qualified: "18%" },
    ],
    topPick: "TBD",
  ...
  },
  {
    id: "J",
    teams: [
      { name: "TBD (CAF 1)", flag: "🏳️", toWin: "7.00", qualified: "45%" },
      { name: "TBD", flag: "🏳️", toWin: "9.00", qualified: "38%" },
      { name: "TBD", flag: "🏳️", toWin: "12.00", qualified: "28%" },
      { name: "TBD", flag: "🏳️", toWin: "20.00", qualified: "15%" },
    ],
    topPick: "TBD",
  ...
  },
  {
    id: "K",
    teams: [
      { name: "TBD (UEFA 1)", flag: "🏳️", toWin: "6.00", qualified: "50%" },
      { name: "TBD", flag: "🏳️", toWin: "8.00", qualified: "42%" },
      { name: "TBD", flag: "🏳️", toWin: "11.00", qualified: "30%" },
      { name: "TBD", flag: "🏳️", toWin: "20.00", qualified: "14%" },
    ],
    topPick: "TBD",
  ...
  },
  {
    id: "L",
    teams: [
      { name: "Canada", flag: "🇨🇦", toWin: "3.80", qualified: "65%" },
      { name: "TBD (CONCACAF)", flag: "🏳️", toWin: "9.00", qualified: "38%" },
      { name: "TBD", flag: "🏳️", toWin: "12.00", qualified: "28%" },
      { name: "TBD", flag: "🏳️", toWin: "18.00", qualified: "18%" },
    ],
    topPick: "Canada (home advantage)",
    venue: "BC Place, Vancouver",
  },
];
