...
const accumulators = [
  ...
  },
  {
    ...
    type: "Match-day",
    legs: [
      { sel: "Mexico to win or draw vs Poland (Group A)", odds: "1.60", tip: "Mexico on home soil at Estadio Azteca — massive home crowd advantage in a must-not-lose opener." },
      { sel: "USA to win vs Panama (Group B)", odds: "1.58", tip: "USA as tournament hosts with strong CONCACAF form — Panama cannot match their quality on the big stage." },
      { sel: "Over 2.5 Goals in Mexico vs Poland", odds: "1.85", tip: "Both sides need points and will push forward; Poland have Lewandowski in form." },
    ],
    analysis: "A three-leg opening weekend accumulator using two outright results and an Over 2.5 goals selection. All three have strong implied probability individually (63%, 63%, 54%) but combine to roughly 21% — giving 7.15 odds that represent real value.",
    stake: "0.5–1 units",
    book: "Betsson",
    bookUrl: BETSSON_URL,
  },
